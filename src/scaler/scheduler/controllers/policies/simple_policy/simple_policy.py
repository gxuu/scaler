...
class SimplePolicy(ScalerPolicy):
    ...
    def get_scaling_commands(
        ...
        return self._scaling_controller.get_scaling_commands(
            snapshot, adapter_heartbeat, worker_groups, worker_group_capabilities
        )
    ...
    def on_scaling_command_response(
        ...
        return self._scaling_controller.on_scaling_command_response(response, worker_groups, worker_group_capabilities)
