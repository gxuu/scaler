...
Scaling controllers communicate with worker adapters using Cap'n Proto messages over the same connection that worker adapters use to connect to the scheduler. The protocol uses the following message types:
